...
<div class="page-header">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.categories') }}">Сургалтын төрөл</a></li>
    <li class="breadcrumb-item active">Add</li>
  </ol>
  <h1 class="page-title">Төрөл нэмэх</h1>
</div>
    ...
    <form method="POST" action="{{ route('admin.saveCategory') }}" id="categoryForm">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
          <label class="form-control-label">Төрлийн нэр <span class="required">*</span></label>
