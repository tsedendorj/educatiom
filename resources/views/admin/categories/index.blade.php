...
<div class="page-header">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Удирдлага</a></li>
    <li class="breadcrumb-item active">Сургалтын төрөл үзэх</li>
  </ol>
  <h1 class="page-title">Сургалтын төрлүүд</h1>
</div>
...
<div class="panel">
        <div class="panel-heading">
            <div class="panel-title">
              <a href="{{ route('admin.categoryForm') }}" class="btn btn-success btn-sm"><i class="icon wb-plus" aria-hidden="true"></i> Төрөл нэмэх</a>
            </div>
