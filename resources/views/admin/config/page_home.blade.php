...
<div class="page-header">
  ...
  <h1 class="page-title">Нүүр хуудас</h1>
</div>
      ...
      <input type="hidden" name="code" value="pageHome">
       <div class="row">
            <div class="form-group col-md-6">
              <label class="form-control-label">Баннер</label>
              <input type="text" class="form-control" name="banner_title" 
                placeholder="Banner Title" value="{{ isset($config['banner_title']) ? $config['banner_title'] : '' }}" />
            </div>
        
            <div class="form-group col-md-6">
              <label class="form-control-label">Баннер текст</label>
            ...
            <div class="form-group col-md-6">
              <label class="form-control-label">Багшийн тухай</label>
