...
<div class="page-header">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Тохиргоо</li>
  </ol>
  <h1 class="page-title">Ерөнхий</h1>
</div>
      ...
      <input type="hidden" name="code" value="settingGeneral">
        <div class="row">
            <div class="form-group col-md-6">
              <label class="form-control-label">Апп нэр</label>
            ...
            <div class="form-group col-md-4">
              <label class="form-control-label">Лого</label>
