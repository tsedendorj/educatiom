    ...
    <div class="container-fluid p-0 home-content">
        ...
        <div class="homepage-slide-blue">
            ...
            <div class="searchbox-contrainer col-md-6 mx-auto">
                <input name="keyword" type="text" class="searchbox d-none d-sm-inline-block" placeholder="Сургалт хайх"><input name="keyword" type="text" class="searchbox d-inline-block d-sm-none" placeholder="Сургалт хайх"><button type="submit" class="searchbox-submit"><i class="fa fa-search"></i></button>
            </div>
            </form>
        </div>
        <!-- banner end -->
        ...
        <?php 
            $tabs = array('latestTab' => 'Сүүлд нэмэгдсэн сургалтууд',
                          'freeTab' => 'Үнэгүй сургалтууд',
                          'discountTab' => 'Төлбөртэй сургалтууд',
                        );
        ?>
                                ...
                                <main>
                                    ...
                                    <div class="instructor-clist">
                                        <div class="col-md-12">
                                            ...
                                            <span>Үүсгэсэн <b>{{ $course->first_name.' '.$course->last_name }}</b></span>
                                        </div>
                                    </div>
                                </main>
                                <footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <a href="{{ route('course.list') }}" class="btn btn-ulearn">Сургалт судлах</a>
                    </div>
