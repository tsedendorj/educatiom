        ...
        <div class="breadcrumb-container">
            <div class="container">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Миний сургалтууд</li>
              </ol>
            </div>
        </div>
            ...
            @else
                <article class="container not-found-block">
                    ...
                    <div class="col-12 not-found-col">
                            ...
                            <h3>Уучлаарай! Таны бүртгэлд нэмэгдээгүй байна</h3>
                            <a href="{{ route('course.list') }}" class="btn btn-ulearn-cview mt-3">Сургалт судлах</a>
                    </div>
                    </div>
                </article>
            @endif                             
