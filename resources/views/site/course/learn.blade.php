        ...
        <div class="breadcrumb-container">
            <div class="container">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('my.courses') }}">Миний сургалт</a></li>
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                <section class="course-feature">
                    ...
                    <ul class="list-unstyled cf-pricing-li">
                        ...
                        <li><i class="far fa-clock"></i>Үргэлжлэх хугацаа: {{ $course->duration ? $course->duration : '-' }}</li>
                        ...
                        <li><i class="fas fa-file-download"></i>Татах боломжтой файл</li>
                    </ul>
                </section>
                ...
                <section class="course_preview_video mt-3">
                    <div class="aligncenter overlay">
                        ...
                        <video controls id="myVideo" style="display:none;">
						    ...
						    Таны броузер тоглуулагчыг дэмжихгүй байна.
						</video>
...
<div class="modal" id="rateModal">
  <div class="modal-dialog">
    ...
    <div class="modal-header bi-header ">
        <h5 class="col-12 modal-title text-center bi-header-seperator-head">Сургалтын үнэлгээ</h5>
