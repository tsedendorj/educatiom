        ...
        <div class="breadcrumb-container">
            <div class="container">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="@if($course_breadcrumb) {{ $course_breadcrumb }} @else {{ route('course.list') }} @endif">Сургалтын жагсаалт</a></li>
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <div class="instructor-clist m-0">
                        <div class="col-md-12 p-0 m-0">
                            ...
                            <span>Үүсгэсэн <b>{{ $course->instructor->first_name.' '.$course->instructor->last_name }}</b></span>
                        </div>
                    </div>
                    <div class="row cv-header">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6  col-6">
                            <div class="cv-category-detail cv-rating float-lg-left float-md-right float-sm-right">
                                <span>{{ $course->ratings->count('rating') }} Шүүмж</span>
                                <br>
                    ...
                    @if($course->overview)
                        <h4 class="mt-4">Сургалтын товч танилцуулга</h4>
                        {!! $course->overview !!}
                    @endif
                    
                    @if($is_curriculum)
                    <!-- curriculum block start -->
                    <h4 class="mt-4">Сургалтын хөтөлбөр</h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                <section class="course-feature">
                    ...
                    <ul class="list-unstyled cf-pricing-li">
                        <li><i class="far fa-user"></i>Сурагчид</li>
                        <li><i class="far fa-clock"></i>Хугацаа: {{ $course->duration ? $course->duration : '-' }}</li>
                        <li><i class="fas fa-bullhorn"></i>Лекц: {{ $lectures_count }}</li>
                        <li><i class="far fa-play-circle"></i>Видео хичээл: {{ $videos_count }}</li>
                        <li><i class="far fa-address-card"></i>Certificate</li>
                        <li><i class="fas fa-file-download"></i>Татаж болох хичээлүүд</li>
                    </ul>
                </section>
                
                @if($video)
                <h6 class="underline-heading mt-3">Сургалтын танилцуулга</h6>
                <section class="course_preview_video mt-3">
                    <div class="aligncenter overlay">
                        ...
                        <video controls id="myVideo" style="display:none;">
						   ...
						   Таны хөтөч Видео тоглуулагч дэмжихгүй байна
						</video>
                ...
                <h6 class="mt-4 underline-heading">Сургалтын ангилал</h6>
