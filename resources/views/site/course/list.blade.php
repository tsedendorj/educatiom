            ...
            <div class="breadcrumb-container">
                <div class="container">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Сургалтын жагсаалт</li>
                  </ol>
                </div>
            </div>
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <form method="GET" action="{{ route('course.list') }}" id="courseList">
                    <span class="blue-title">Үр дүн шүүх</span>
                    @if($_GET)
                    <a href="{{ route('course.list') }}" class="clear-filters"><i class="fa fa-sync"></i>&nbsp;Шүүлтийг арилгах</a>
                    @endif
                    <h6 class="mt-2 underline-heading">Ангилал</h6>
                    ...
                    <h6 class="mt-3 underline-heading">Үнэ</h6>
                    <?php $levels = array(
                                            '0-0' => 'Үнэгүй',
                                            '1-5000' => 'хамгийн хямд ₮ 5000',
                                            '5000-9900' => '₮ 5000 - ₮ 9900',
                                            '10000-19900' => '₮ 10000 - ₮ 19900',
                                            '20000-29900' => '₮ 20000 - ₮ 29900',
                                            '30000-39900' => '₮ 30000 - ₮ 39900',
                                            );
                    ?>
                    <ul class="ul-no-padding">
                ...
                <div class="col-xl-10 col-lg-10 col-md-9">
                    <div class="row px-2">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
                            <span >Үзэх {{ $courses->currentPage() }} of {{ $courses->lastPage() }} page(s)</span>
                        </div>
