            ...
            <div class="breadcrumb-container">
                <div class="container">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="@if($course_breadcrumb) {{ $course_breadcrumb }} @else {{ route('course.list') }} @endif">Хичээлийн жагсаалт</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('course.view', $course->course_slug) }}">Хичээл</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Тооцоо хийх</li>
                  </ol>
                </div>
            </div>
        ...
        <article class="container mt-4">
            <div class="row">
               <div class="col-xl-7 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <h6 class="underline-heading mb-4">Худалдан авалтыг баталгаажуулна уу</h6>
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-8">
                            ...
                            <div class="instructor-clist mb-0 mt-1 d-sm-block d-none">
                                <div class="ml-1">
                                    ...
                                    <span>Сургалтын төрөл сонгох <b>{{ $course->category->name }}</b></span>
                                </div>
                            </div>
