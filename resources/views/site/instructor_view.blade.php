            ...
            <div class="breadcrumb-container">
                <div class="container">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('instructor.list') }}">Багш</a></li>
                    ...
                    <div class="instructor-profile-box mx-auto">
                        <main>
                            ...
                            <ul class="list-unstyled cf-pricing-li">
                                ...
                                <li><i class="fas fa-bullhorn"></i>Лекц: {{ $metrics['lectures'] }}</li>
                                <li><i class="far fa-play-circle"></i>Видео: {{ $metrics['videos'] }}</li>
                            </ul>
                        </main>
                    </div>
                        ...
                        <div class="px-4 py-2">
                            <form class="form-horizontal" method="POST" action="{{ route('contact.instructor') }}" id="instructorForm">
                                ...
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn btn-lg btn-block login-page-button">мессеж илгээх</button>
                                </div>
                            </form>
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <div class="row">
                        <div class="col-12 text-center seperator-head mt-0">
                            <h4>Сургалтууд</h4>
                            <p class="mt-3">Заасан сургалтууд {{ $instructor->first_name.' '.$instructor->last_name }}</p>
                        </div>
                    </div>
