            ...
            <div class="breadcrumb-container">
                <div class="container">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('blogs') }}">Блогууд</a></li>
            ...
            <div class="row mt-4">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-4 col-sm-4 col-12">
                                    <div class="instructor-clist m-0 pt-1">
                                        <div>
                                            ...
                                            <span><i class="d-md-none d-sm-none d-lg-inline-block">Нийтлэгдсэн</i> <b>{{ $blog->created_at->diffForHumans() }}</b></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                    <section class="course-feature">
                        <h6 class="text-center mt-3">Сургалт судлах</h6>
                    ...
                    <h6 class="mt-4 underline-heading">Блог архив</h6>
