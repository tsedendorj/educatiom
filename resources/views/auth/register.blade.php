        ...
        <div class="container">
            <nav class="navbar clearfix secondary-nav pt-0 pb-0 login-page-seperator">
                <ul class="list mt-0">
                     ...
                     <li><a href="{{ route('register') }}" class="active">Бүртгүүлэх</a></li>
                </ul>
            </nav>
                        ...
                        <div class="p-4">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        <label>Овог</label>
                                        <input type="text" class="form-control form-control-sm" placeholder="Овог" value="@if(!empty($name)){{ $name }}@else{{ old('first_name') }}@endif" name="first_name"   >
                                    ...
                                    <div class="col-6">
                                        <label>Нэр</label>
                                        <input type="text" class="form-control form-control-sm" placeholder="Нэр" value="{{ old('last_name') }}" name="last_name">
                            ...
                            <div class="form-group">
                                <label>Нууц үг</label>
                                <input type="password" class="form-control form-control-sm" placeholder="Нууц үг" name="password" id="password">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-sm" placeholder="Нууц үг ээ дахин оруулна уу" name="password_confirmation">
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-lg btn-block login-page-button">Бүртгүүлэх</button>
                            </div>
