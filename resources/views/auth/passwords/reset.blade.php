                        ...
                        <div class="p-4">
                            ...
                            <div class="form-group">
                                <div class="row m-0">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ url('login') }}" class="float-right forgot-text">Нэвтрэх хуудасруу буцах</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-block login-page-button">Нууц үг сэргээх</button>
                            </div>
