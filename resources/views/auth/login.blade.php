    ...
    <div class="container-fluid p-0 home-content container-top-border">
        ...
        <div class="container">
            <nav class="navbar clearfix secondary-nav pt-0 pb-0 login-page-seperator">
                <ul class="list mt-0">
                     <li><a href="{{ route('login') }}" class="active">Нэвтрэх</a></li>
                        ...
                        <div class="p-4">
                            ...
                            <div class="form-group">
                                <div class="row m-0">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('password.request') }}" class="float-right forgot-text">Нууц үг ээ мартсан уу?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-block login-page-button">Нэвтрэх</button>
                            </div>
