...
<html>
        ...
        <div class="row" style="flex-grow: 1;">
            ...
            <div class="col-md-3 col-lg-6 col-xl-6 d-none d-md-block">
                <div class="dropdown float-left" >
                  <span id="dropdownMenuButton" data-toggle="dropdown">Сургалтын төрөл сонгох &nbsp;<i class="fa fa-caret-down"></i></span>
                    <?php 
            ...
            <div class="col-sm-5 col-md-3 col-lg-2 col-xl-2 d-none d-sm-block">
                ...
                <span class="become-instructor" href="{{ route('login') }}" data-toggle="modal" data-target="#myModal">Багш болох</span>
                @endif
            </div>

            <div class="col-6 col-sm-3 col-md-3 col-lg-2 col-xl-2">
                @guest
                <a class="btn btn-learna" href="{{ route('login') }}">Нэвтрэх / Бүртгүүлэх</a>
                @else
                <div class="dropdown float-xl-left float-sm-right float-right">
                 ...
                 <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButtonRight">
                    ...
                    <a class="dropdown-item" href="{{ route('instructor.dashboard') }}" >
                        <i class="fa fa-sign-out-alt"></i> Багш
                    </a>
                    @endif

                    <a class="dropdown-item" href="{{ route('my.courses') }}" >
                        <i class="fa fa-sign-out-alt"></i> Миний сургалт
                    </a>

                    <a class="dropdown-item" href="{{ route('logOut') }}" >
                        <i class="fa fa-sign-out-alt"></i> Системээс гарах
                    </a>
    ...
    <div id="sidebar">
        <ul>
           <li><a href="javascript:void(0)" class="sidebar-title">Сургалтын төрлүүд</a></li>
           @foreach ($categories as $category)
           <li>
    ...
    <footer id="main-footer">
        <div class="row m-0">
            <div class="col-lg-2 col-md-4 col-sm-4 col-6 mt-3">
                <ul>
                    <li class="mb-1"><b>Холбогдох хуудсууд</b></li>
                    <li><a href="{{ route('home') }}">Нүүр хуудас</a></li>
                    <li><a href="{{ route('course.list') }}">Сургалтын жагсаалт</a></li>
                    <li><a href="{{ route('instructor.list') }}">Багш нар</a></li>
                    <li><a href="{{ route('blogs') }}">Блогууд</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-4 col-6 mt-3">
                <ul>
                    <li class="mb-1"><b>Эх сурвалж</b></li>
                    <li><a href="{{ route('page.about') }}">Тухай</a></li>
                    <li><a href="{{ route('page.contact') }}">Холбоо барих</a></li>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 mt-3 d-none d-sm-block">
                <ul>
                    <li class="mb-1"><b>Шилдэг хичээлүүд</b></li>
                    @foreach ($categories as $category)
                        @if($loop->iteration <= 4)
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 text-center mt-4">
                ...
                <br>
                <span id="c-copyright">
                    Copyright © 2019, EDUMONGOLIA. All rights reserved.
                </span>
            </div>
        </div>
    </footer>
    ...
    <div class="modal" id="myModal">
      <div class="modal-dialog">
        ...
        <div class="modal-header bi-header ">
            <h5 class="col-12 modal-title text-center bi-header-seperator-head">Багш болох</h5>
                ...
                <div class="px-4 py-2">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-6">
                                <label>Овог</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Овог" name="first_name">
                            </div>
                            <div class="col-6">
                                <label>Нэр</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Нэр" name="last_name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Имейл</label>
                        <input type="text" class="form-control form-control-sm" placeholder="Имейл" name="contact_email">
                    </div>

                    <div class="form-group">
                        <label>Утас</label>
                        <input type="text" class="form-control form-control-sm" placeholder="Утас" name="telephone">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control" placeholder="Biography" name="Товч намтар"></textarea>
                    </div>

                    <div class="form-group mt-4">
                        <button type="submit" class="btn btn-lg btn-block login-page-button">Баталгаажуулах</button>
                    </div>
