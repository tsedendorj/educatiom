...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        ...
        <span class="navbar-brand-text hidden-xs-down">edumongolia</span>
      </div>
      <button type="button" class="navbar-toggler collapsed" data-target="#site-navbar-search"
        data-toggle="collapse">
        <span class="sr-only">Хайлт хийх</span>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              <a class="dropdown-item" href="{{ url('/') }}" role="menuitem"><i class="icon fas fa-home" aria-hidden="true"></i>Нүүр хуудас</a>
              <div class="dropdown-divider" role="presentation"></div>
              <a class="dropdown-item" href="{{ route('logOut') }}" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Системээс гарах</a>
            </div>
          </li>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">edumongolia</a></div>
  </footer>
  <!-- Core  -->
